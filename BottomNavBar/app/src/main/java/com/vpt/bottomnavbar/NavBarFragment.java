...
public class NavBarFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        botNavBar = view.findViewById(R.id.bnv_navbar);
        botNavBar.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                fragmentManager.beginTransaction()
                        .replace(R.id.fl_content_container, selectedFragment)
                        .commit();
                return true;
            }
        });
        botNavBar.setSelectedItemId(R.id.mi_home);
    }
}